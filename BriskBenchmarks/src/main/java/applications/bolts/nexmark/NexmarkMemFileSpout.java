...
public class NexmarkMemFileSpout extends AbstractSpout {
    private static final Logger LOG = LoggerFactory.getLogger(NexmarkMemFileSpout.class);
    ...
    public void initialize(int thread_Id, int thisTaskId, ExecutionGraph graph) {
        ...
        try {
            ...
            String inputFile = "/home/zxchen/nexmark_test_data.bin";
            ...
            System.out.println("Third tuple in nexmark buffer");
            for (int j = 0; j < tupleSize; j ++) {
