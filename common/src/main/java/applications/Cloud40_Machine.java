...
public class Cloud40_Machine extends Platform {

    private static final long serialVersionUID = 2511492570058016274L;

    public Cloud40_Machine() {
...
//         };
        ...
        this.CLOCK_RATE = 1.00059 ;//1.2GHz ... 2.5 cycles per nanosecond, in real, it's about 1.2. so we use UNHALTED_REFERENCE_CYCLES that does not affect.
        this.cache_line = 64.0;//bytes
        this.num_socket = 2;
        this.CoresPerSocket = 24;
        this.num_cores = 48;
