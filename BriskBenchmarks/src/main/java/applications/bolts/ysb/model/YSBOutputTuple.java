...
public class YSBOutputTuple extends StreamValues {
    ...
    // public YSBOutputTuple(String string) {

    // }

    // public YSBOutputTuple(char[] string) {
    ...
    public YSBOutputTuple(String campaignId, long eventTime) {
        this.campaignId = campaignId;
        this.eventTime = eventTime;
        super.add(0, campaignId);
        super.add(1, eventTime);
    }

    // public YSBOutputTuple(int x) {
